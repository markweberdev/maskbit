""" Credits: torch metrics / fidelity """
# Unfortunately, the release of torch-fidelity is behind the bug-fixes, so code is copied and modified accordingly.
import torch
...
if __name__ == "__main__":
    ...
    a = torch.randint(low = 0, high=255, size=(8, 3, 256, 256), dtype=torch.uint8)
    print(model(a))